...
public final class MoveRankDefinition {
  ...
  public static double severity(double winrateDiff, double scoreDiff, Config config) {
    double winrateSeverity = 0.0;
    double scoreSeverity = 0.0;
    if (config == null || config.useWinLossInMoveRank) {
      winrateSeverity =
          metricSeverity(
              winrateDiff,
    ...
    if (config == null || config.useScoreLossInMoveRank) {
      scoreSeverity =
          metricSeverity(
              scoreDiff,
  ...
  public static Color severityColor(double severity) {
    Color[] stops = {
      Rank.BEST.color(false),
      Rank.GOOD.color(false),
      Rank.NORMAL.color(false),
      Rank.INACCURACY.color(false),
      Rank.MISTAKE.color(false),
      Rank.BLUNDER.color(false),
