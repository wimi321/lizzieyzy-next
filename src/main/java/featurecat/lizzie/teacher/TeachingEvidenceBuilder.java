...
public final class TeachingEvidenceBuilder {
    ...
    static long playedVisitsOf(TeacherPanel.MoveAnalysis analysis) {
    ...
    static List<TeachingEvidenceCandidate> uniqueHintCandidates(TeacherPanel.MoveAnalysis analysis) {
    ...
    static TeachingPacingAdvice buildTeachingPacingAdvice(TeacherPanel.MoveAnalysis analysis, List<KnowledgeReference> knowledgeMatches, List<RecognizedMotifView> recognizedMotifs) {
    ...
    public static TeachingEvidence buildTeachingEvidence(TeacherPanel.MoveAnalysis analysis, String userPrompt, List<MotifRecognizer.RecognizedTeachingMotif> motifs,
