...
- 棋盘同步工具：感谢 [qiyi71w/readboard](https://github.com/qiyi71w/readboard) 作者 [qiyi71w](https://github.com/qiyi71w) 持续优化 readboard，对 `LizzieYzy Next` 的棋盘同步体验帮助很大。也欢迎更多朋友参与到这个项目中来，一起把它打磨得更好。
野狐抓谱历史参考：
